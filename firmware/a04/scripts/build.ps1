...
if ($Mode -in @('all','host')) {
    ...
    Invoke-A04Build $a04Python @((Join-Path $PSScriptRoot 'verify_transfer.py')) 'transfer-verification.txt'
    ...
    Invoke-A04Build $a04Python @((Join-Path $PSScriptRoot 'verify_storage.py')) 'storage-verification.txt'
