...
| Firmware on actual hardware | Reproducible build, protocol/storage tests, real microphone/radio/charge/haptic/boot/OTA and fault tests | Real Opus/C archive host tests and ARM cross-build pass at 173,752 B flash / 91,776 B RAM; no on-device execution or complete A04 firmware |
