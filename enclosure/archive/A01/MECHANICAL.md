...
AURA is a discreet, screen-free note-taking pendant. A shallow circular record key is easy to find by touch, an illuminated pinhole communicates recording, two separated acoustic ports admit speech, and a recessed physical privacy slider provides a clear off position. A detachable black cord passes through a reinforced eyelet. The flat rear face is comfortable against clothing and has three recessed charging contacts, aligned with the PCB's J1 interface. Bookmarking uses the planned double-press gesture on the main record key; SW3 is an optional internal/debug input without a case aperture.
...
| RF exclusion | No cell or conductive coating behind upper antenna region, Y > +11.95 through the PCB's +17 upper edge; maintain RF-transparent front/side housing around this enlarged strip |
...
| Three charging contact centers | X −3, 0, +3; Y −15, rear face; exposed contact Ø1.70, matching J1's PCB pad diameter |
| Charging contact carrier | Center (0, −15); 9.8 × 2.9 footprint; thin passive lead/flex interposer required around the cell to J1 |
| Retainer centerlines | (0, +18.4), (0, −18.4); outside PCB ends; top retainer must be nonconductive polymer because it is near the antenna |
...
2. Install the three-pad rear charging-contact carrier, insulated protected cell and soft battery locators. Connect the carrier to PCB J1 with a thin passive flex or insulated lead interposer routed around the cell perimeter. The PCB and case pads share XY coordinates but occupy opposite sides of the battery; long pogo pins directly through that stack are invalid. Interposer routing, termination, insulation, strain relief and assembly tolerances remain production engineering; the model does not claim that this passive interposer is designed. Do not compress, pierce, or bend the cell. The refined stack provides 0.4mm rear clearance and 0.5mm free space above the insulation. Confirm that allowance against the selected cell datasheet; a thinner cell or deeper rear shell may still be necessary.
...
7. Seat the 0.32mm seam gasket and close the shell using the two prototype retention points. The upper retainer must be nonconductive polymer; a metal fastener only1.4mm beyond the PCB top is undesirable near the antenna. The lower retainer may use a metal M1.2 fastener. Select the exact fastener/retainer after checking head diameter against the 2.04mm counterbore and measuring usable pilot engagement. The rendered heads are visual envelopes; no screw standard or qualified polymer retention design is implied. Ream/tune printed pilot holes rather than forcing a screw. Case bosses approach the PCB end with about0.15mm nominal clearance, so this area needs explicit tolerance checking.
8. Fit a detachable, washable nonmetallic neck cord with a breakaway clasp. The cord in the beauty model is a presentation segment, not a complete clasp or a tensile-tested strap. RF validation must include the worn configuration and any proposed chain or metallic accessory; a conductive chain is not an approved substitution.
...
Named primary meshes: `Housing_Front`, `Housing_Back`, `Record_Button`, `Privacy_Slider`, `Seam_Gasket`, `LED_Lightpipe`, `PCB_Reference`, `Battery_Envelope`, `RF_Module_Envelope`, `Charging_Contact_1` through `Charging_Contact_3`, `Cord_Woven_Left`, `Cord_Woven_Right`.
...
The same saved-file verifier asserts exactly three1.70mm charging contacts atX−3,0,+3 andY−15. All three exported GLBs were independently parsed to confirm the same contact count and XY positions. Hero, detail and exploded PNGs were preserved byte-for-byte during this rear-interface correction; only the rear PNG was rerendered.
