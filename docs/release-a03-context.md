...
| --- | --- |
| Electronics | [Hardware source, native schematic and current fabrication status](../hardware/README.md) |
| Schematic | [Six-page PDF](../hardware/output/aura-a03-native-schematic.pdf) · [editable native source](../hardware/output/aura-a03-electrical.kicad_sch) |
...
| Enclosure synchronization | All 61 placements match the hardware source. The GLB audit checks 56 package transforms and 50 body dimensions. All eight STL files remain byte-identical to the previous A03 print geometry. [Model audit](../enclosure/model-sync-audit.json) · [print invariance](../enclosure/print-invariance.json). |
