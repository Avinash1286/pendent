...
|---|---|---|
| Reference-aligned design | Inspected exterior/interior renders, dimensioned mechanical contract, actual component stack-up | Circular Blender allocation study inspected; 10.8 mm actual-board stack, no fit qualification |
...
| Printable, assembled body and dock | Watertight STL/3MF/STEP as applicable, units/wall/fit/clearance/fastener/motion checks, physical prints and assembled fit | Nine unpowered fit specimens pass mesh/dimension checks; complete body/dock and physical prints remain |
| Firmware on actual hardware | Reproducible build, protocol/storage tests, real microphone/radio/charge/haptic/boot/OTA and fault tests | Isolated real Opus host/ARM builds and independent audio decode pass; no on-device execution or complete A04 firmware |
| Reliable local/mobile context loop | Real-phone capture/sync/recovery, durable receipts, source-linked transcription/search/context, account and permission tests | 47 companion tests including experimental v2 receiver; actual transport/mobile/end-to-end integration remains |
